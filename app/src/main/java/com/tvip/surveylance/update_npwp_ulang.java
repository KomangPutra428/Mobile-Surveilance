...
public class update_npwp_ulang extends AppCompatActivity {
    RelativeLayout npwp;
    Bitmap npwpbitmap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_npwp_ulang);
        ...
        proses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(nomornpwp.getText().toString().length() == 0){
                    ...
                    new SweetAlertDialog(update_npwp_ulang.this, SweetAlertDialog.WARNING_TYPE)
                    ...
                    pDialog = new SweetAlertDialog(update_npwp_ulang.this, SweetAlertDialog.PROGRESS_TYPE);
                    ...
                    RequestQueue requestQueue2 = Volley.newRequestQueue(update_npwp_ulang.this);
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    if (status.contains("Success")) {
                                        ...
                                        pDialog.cancel();
                                        new SweetAlertDialog(update_npwp_ulang.this, SweetAlertDialog.ERROR_TYPE)
        ...
        npwp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivityCompat.requestPermissions(update_npwp_ulang.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 2);
